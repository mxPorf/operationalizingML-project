...
def create_data_loaders(data, batch_size):
    train_data_path = os.path.join(data, 'final-project/train')
    test_data_path = os.path.join(data, 'final-project/test')
    validation_data_path=os.path.join(data, 'final-project/valid')
...
def main(args):
    ...
    ######
    subdirectories = next(os.walk(args.data))[1]
